...
//   생성자에는 @Autowired 를 생략 가능
    public Car(@Value("red") String color, @Value("100") int oil, @Qualifier("engine") Engine engine, Door[] doors) {
        this.color = color;
        this.oil = oil;
        this.engine = engine;
        this.doors = doors;
...
public class ApplicationContextTest_practice {
